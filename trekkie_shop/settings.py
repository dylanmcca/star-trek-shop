"""
Django settings for trekkie_shop project.
...
SECRET_KEY = 'django-insecure-%&t*7tl0(5)lk7*nk-duwkcbo8t_4*!787349qgw=li!heu@l@'
...
ROOT_URLCONF = 'trekkie_shop.urls'
...
WSGI_APPLICATION = 'trekkie_shop.wsgi.application'
